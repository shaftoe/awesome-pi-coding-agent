...
|-------|-------|--------|------------------|
| **1. Discover** | APIs (npm, GitHub, YouTube, HN) | `.cache/candidates/` | Gather raw candidates, cache API responses. **No filtering.** |
...
| `bun run discover -- --query [source:]term` | 1 | Override source queries (prefixes: `npm:`, `gh:`, `yt:`, `hn:`) |
